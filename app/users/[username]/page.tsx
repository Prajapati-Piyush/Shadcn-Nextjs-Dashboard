                        ...
                        <div className="flex gap-4 mt-4">
                            <HoverCard>
                                ...
                                <HoverCardContent>
                                    ...
                                    <p className="text-sm text-muted-foreground">The user has been verified by the admin</p>
                                </HoverCardContent>
                            </HoverCard>
                            <HoverCard>
                                <HoverCardTrigger>
                                ...
                                <HoverCardContent>
                                    ...
                                    <p className="text-sm text-muted-foreground">Admin users have access to all features and can manage</p>
                                </HoverCardContent>
                            </HoverCard>
                            <HoverCard>
                                <HoverCardTrigger>
                ...
                <div className="w-full xl:w-2/3 space-y-6">
                    ...
                    <div className="bg-primary-foreground p-4 rounded-lg space-y-2">
                       <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-xl font-semibold">John Doe
                        </h1>
                       </div>
                       <p className="text-sm text-muted-foreground">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Cum nulla reiciendis, accusamus culpa laborum et facilis suscipit? Inventore, nihil dolorum!</p>
                    </div>
                    {/* Chart Container */}
                    <div className="bg-primary-foreground p-4 rounded-lg">
